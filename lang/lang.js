export const translations = [
    {
        ...
        encodePlaceholder: 'Ingrese texto a encriptar',
        decodePlaceholder: 'Ningún texto fue encontrado',
        btnEncode: 'encriptar',
        ...
        charMsg: {
            ...
            successEncode: 'Excelente!!',
            successDecode: 'Desencriptado!!',
            warnMsg: '!!! Vaya, parece que algo salió mal',
            copyMsg: 'mensaje copiado con éxito!'
        }
    },
    {
        language: 'eng',
        title: 'Text Encryptor',
        encodePlaceholder: 'Enter text to encrypt',
        decodePlaceholder: 'No text found',
        btnEncode: 'encrypt',
        btnDecode: 'decrypt',
        btnCopy: 'copy',
        ...
        charMsg: {
            ...
            successEncode: 'Excellent!!',
            successDecode: 'Decrypted!!',
            warnMsg: '!!! Oops, something went wrong',
            copyMsg: 'Message copied successfully!'
        }
    },
    {
        language: 'pt',
        title: 'Criptografador de Texto',
        encodePlaceholder: 'Digite o texto para criptografar',
        decodePlaceholder: 'Nenhum texto encontrado',
        btnEncode: 'codificar',
        ...
        charMsg: {
            ...
            successEncode: 'Excelente!!',
            successDecode: 'Descriptografado!!',
            warnMsg: '!!! Ops, algo deu errado',
            copyMsg: 'Mensagem copiada com sucesso!'
        }
    }
];
